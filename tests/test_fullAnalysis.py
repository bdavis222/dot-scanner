...
class TestFullAnalysis(unittest.TestCase):
	...
	def test_getPathFromBase(self):
		...
		self.assertTrue(filename3.endswith("dotscanner/two/folders/filename3.txt"))
	...
	def test_densityAnalysis(self):
		...
		self.assertTestDataFilesEquivalent("densityTestOutput.txt", "densityExpectedOutput.txt")
	...
	def test_densityAnalysis2(self):
		...
		self.assertTestDataFilesEquivalent("densityTestOutput.txt", "densityExpectedOutput2.txt")
