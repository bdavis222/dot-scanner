...
Some demo images are included in the [images/demo/ folder](https://github.com/bdavis222/dotscanner/blob/main/images/demo/) of this GitHub project, which can be downloaded and used as explained below to familiarize oneself with how the software works. 
...
If the **File** or **Folder** buttons are clicked, another window opens, allowing the user to select a file or folder for analysis (the images in the [images/demo/ folder](https://github.com/bdavis222/dotscanner/blob/main/images/demo/) can be downloaded to try this out for oneself):
