...
#### Blobs
These buttons adjust the sensitivity for detecting “blobs” in the image. The user can also press the **right** and **left** arrow keys on the keyboard to make these adjustments. *Note that since increasing the blob sensitivity effectively lowers the threshold between blobs and dots, this may result in a different number of dots being detected.*
