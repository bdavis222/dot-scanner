...
If the **File** or **Folder** buttons are clicked, another window opens, allowing the user to select a file or folder for analysis (one can try this out by downloading the images in `images/demo/` and pointing to the location of that download):
